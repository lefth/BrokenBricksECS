...
namespace ECS
{
    ...
    {
        const string TComponentIsIComponentTypeException = "TComponent cant be IComponent directly! Please cast to the specific Type";
    ...
    public class EntityManager : IComponentAddedToEntityEventListener, IComponentRemovingFromEntityEventListener, IComponentRemovedFromEntityEventListener, IComponentChangedOfEntityEventListener
    {
        ...
        readonly static Type _iComponentType = typeof(IComponent);

        int _nextEntityId = 0;
        readonly Stack<int> _freeEntityIds = new Stack<int>();
